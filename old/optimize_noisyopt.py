...
goto_start = np.array([22500, 22500, 22500])
...
try:
	...
	s21_mag([0,0,0])
	result = minimizeCompass(s21_mag, bounds=bnds, x0=goto_start, deltatol=4000, feps=0.3, funcNinit=1, disp=True, paired=False)
